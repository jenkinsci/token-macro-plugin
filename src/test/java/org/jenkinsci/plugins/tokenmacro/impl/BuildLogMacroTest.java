...
public class BuildLogMacroTest {
    ...
    @Test
    public void testGetContent_shouldConcatLogWithoutLineLimit() throws Exception {
    ...
    @Test
    public void testGetContent_shouldDefaultToMaxLines() throws Exception {
        buildLogMacro.evaluate(build, listener, BuildLogMacro.MACRO_NAME);
    ...
    @Test
    public void testGetContent_shouldDefaultToNotEscapeHtml() throws Exception {
    ...
    public void shouldRaiseException_on_zeroMaxLines() throws Exception {
        buildLogMacro.maxLines = 0;
        buildLogMacro.evaluate(build, listener, BuildLogMacro.MACRO_NAME);
    }

    @Test(expected = MacroEvaluationException.class)
    public void shouldRaiseException_on_negativeMaxLines() throws Exception {
        buildLogMacro.maxLines = -1;
        buildLogMacro.evaluate(build, listener, BuildLogMacro.MACRO_NAME);
    }

    @Test(expected = MacroEvaluationException.class)
    public void shouldRaiseException_on_negativeTruncTailLines() throws Exception {
        buildLogMacro.truncTailLines = -1;
        buildLogMacro.evaluate(build, listener, BuildLogMacro.MACRO_NAME);
    }

    @Test
    public void shouldTruncateLog_on_nonzero_truncTailLines() throws Exception {
        buildLogMacro.truncTailLines = 1;
        when(build.getLog(anyInt())).thenReturn(testLog);
    ...
    @Test
    public void shouldTruncateFullLog_on_large_truncTailLines() throws Exception {
    ...
    @Test
    public void testGetContent_truncated_with_maxLineLength() throws Exception {
    ...
    @Test
    public void testGetContent_untruncated_with_maxLineLength() throws Exception {
